...
void __stdcall hooks::paint_traverse::hook(unsigned int panel, bool force_repaint, bool allow_force) {
	...
	std::string print = "Kanyecheats|Version:Alpha0.7|Build:12/2/2020";

	switch (panel_to_draw) {

	case fnv::hash("MatSystemTopPanel"):
render::draw_filled_rect(width - 1920, 0, 198, 20, color::blue(255));
		render::draw_filled_rect(width - 1920, 1, 198, 3, color::green(255));
		render::draw_filled_rect(width - 1920, 20, 198, 3, color::red(255));
		render::text(width - 1920, 7, render::fonts::watermark_font, print.c_str(), false, color::green(255));

		break;

	    fnv::hash("FocusOverlayPanel");
